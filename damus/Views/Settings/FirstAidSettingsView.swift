...
struct FirstAidSettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            if damus_state.contacts.event != nil {
                Text(NSLocalizedString("We did not detect any issues that we can automatically fix for you. If you are having issues, please contact Damus support support@damus.io", comment: "Message indicating that no First Aid actions are available."))
            }
        }
